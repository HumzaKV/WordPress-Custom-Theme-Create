...
function retail_shop_styles()
{
	...
	wp_enqueue_style('bootstrap-5-css', 'https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css');
	wp_enqueue_script('bootstrap-5-js', 'https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.bundle.min.js');
	// test_carosel
	// fancybox
	...
	wp_localize_script('script-js', 'ajaxpost', array('ajaxurl' => admin_url('admin-ajax.php')));
...
add_action('admin_enqueue_scripts', 'retail_shop_styles');
add_action('wp_enqueue_scripts', 'retail_shop_styles');

// function my_admin_scripts() {
	
	//     wp_localize_script('script-js', 'ajaxpost', array(
			...
			*/
			function retail_shop_default_header()
			{
				...
				<?php if (function_exists('the_custom_logo') && has_custom_logo()): ?>
					<?php the_custom_logo();?>
					<?php endif;?>
					<div class="site-branding-text" style=" <?php if (!$ecommerce_star_option['header_show_title_tag']) {
						echo 'display:none';
					}
					?>" >
