...
function wc_offline_gateway_plugin_links( $links ) {
	...
	$plugin_links = array(
		'<a href="' . admin_url( 'admin.php?page=wc-settings&tab=checkout&section=offline_gateway' ) . '">' . 'Configure' . '</a>'
	);
...
function wc_offline_gateway_init() {
	...
	class WC_Gateway_Offline extends WC_Payment_Gateway {
		...
		public function __construct() {
			...
			$this->method_title       = 'Offline';
			$this->method_description = 'Allows offline payments. Very handy if you use your cheque gateway for another payment method, and can help with testing. Orders are marked as "on-hold" when received.';
